"""
Test: Lebenshilfe Bad Tölz-Wolfratshausen Personas - Professionell + Künstlerisch

Heilerziehungspfleger:in - Eingliederungshilfe/Teilhabe
...
COMPANY = "Lebenshilfe Bad Tölz-Wolfratshausen"
...
PERSONAS = [
    {
        "id": 1,
        "name": "Die heimatnahe HEP",
        "values": "Wohnortnähe, feste Teams, Sinn",
        "pain": "Pendeln nach München, anonyme Großstrukturen",
        "hook": "Arbeite nah, wirksam und mit echtem Beziehungskern.",
        "subline": "Wohnortnah. Feste Teams. Sinnvolle Arbeit.",
        "cta": "Jetzt bewerben",
        "designer": "team",
    ...
    {
        "id": 2,
        "name": "Die erfahrene Querwechslerin",
        "values": "Stabilität, klare Aufgaben, Wertschätzung",
        "pain": "Überforderung im alten System, fehlende Passung",
        "hook": "Deine Erfahrung zählt – wir qualifizieren gezielt nach.",
        "subline": "Deine Erfahrung. Gezielte Qualifizierung. Echte Wertschätzung.",
        "cta": "Mehr erfahren",
        "designer": "lifestyle",
    ...
    {
        "id": 3,
        "name": "Der strukturierte Fachprofi",
        "values": "Planungssicherheit, Pauschalen, Verlässlichkeit",
        "pain": "Chaosdienste, ständiger Personalmangel",
        "hook": "Ein Plan, ein Team, echte Entlastung – auch im Norden.",
        "subline": "Planungssicherheit. Faire Pauschalen. Echte Entlastung.",
        "cta": "Kennenlernen",
        "designer": "job_focus",
...
async def generate_persona_creative(persona: dict, is_artistic: bool):
    """
    Generiert ein Creative für Lebenshilfe Bad Tölz-Wolfratshausen Persona
    ...
    if is_artistic:
        ...
        artistic_desc = "watercolor painting, soft brush strokes, warm vibrant colors, inclusive illustration, community atmosphere"
        style_prompt = f"inclusive, empowering, community, meaningful work, supportive, ARTISTIC RENDERING: {artistic_desc}"
        layout = persona['art_layout']
        visual = persona['art_visual']
        designer = "artistic"  # WICHTIG für künstlerische Motive
    else:
        # Professioneller Stil
        style_prompt = "inclusive, empowering, community, meaningful work, supportive"
...
async def test_toelz_personas():
    """Generiert 6 Creatives (3 Personas x 2 Stile) für Bad Tölz-Wolfratshausen"""
    print("="*70)
    print("LEBENSHILFE BAD TÖLZ-WOLFRATSHAUSEN - PERSONAS")
    print("="*70)
    ...
    # Zusammenfassung
    print(f"\n\n{'='*70}")
    print("ZUSAMMENFASSUNG - BAD TÖLZ-WOLFRATSHAUSEN CREATIVES")
    print("="*70)
...
if __name__ == "__main__":
    asyncio.run(test_toelz_personas())
