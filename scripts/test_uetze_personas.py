"""
Test: Seniorenheim Haus Monika Uetze Personas - Professionell + Künstlerisch

Pflegefachkraft - Stationäre Seniorenpflege
...
COMPANY = "Seniorenheim Haus Monika"
...
PERSONAS = [
    {
        "id": 1,
        "name": "Die bodenständige Land-PFK",
        "values": "Sicherheit, Nähe, feste Teams",
        "pain": "Chaosdienste, Springer, ständige Mehrarbeit",
        "hook": "Ein Haus, ein Team, ein verlässlicher Plan.",
        "subline": "Feste Teams. Klare Strukturen. Verlässliche Planung.",
        "cta": "Jetzt bewerben",
        "designer": "team",
    ...
    {
        "id": 2,
        "name": "Die erschöpfte Pendlerin",
        "values": "kurze Wege, Planbarkeit, Entlastung",
        "pain": "lange Fahrzeiten, falsche Jobversprechen",
        "hook": "Arbeiten nah am Zuhause – ohne Zeitverlust.",
        "subline": "Kurze Wege. Planbare Dienste. Mehr Lebensqualität.",
        "cta": "Mehr erfahren",
        "designer": "lifestyle",
    ...
    {
        "id": 3,
        "name": "Die loyale Teamstütze",
        "values": "Wertschätzung, Stabilität, Fairness",
        "pain": "Dauer-Mehrarbeit, Leihkräfte, Burnout-Gefahr",
        "hook": "Wir stabilisieren das Team – gemeinsam, dauerhaft.",
        "subline": "Wertschätzung. Stabilität. Faire Bedingungen.",
        "cta": "Kennenlernen",
        "designer": "team",
...
async def generate_persona_creative(persona: dict, is_artistic: bool):
    """
    Generiert ein Creative für Uetze-Persona
    ...
    if is_artistic:
        ...
        artistic_desc = "watercolor painting, soft brush strokes, warm colors, cozy illustration, caring atmosphere"
        style_prompt = f"caring, warm, stable, rural charm, family-like, ARTISTIC RENDERING: {artistic_desc}"
        layout = persona['art_layout']
        visual = persona['art_visual']
        designer = "artistic"  # WICHTIG für künstlerische Motive
    else:
        # Professioneller Stil
        style_prompt = "caring, warm, stable, rural charm, family-like, professional"
...
async def test_uetze_personas():
    """Generiert 6 Creatives (3 Personas x 2 Stile) für Uetze"""
    print("="*70)
    print("SENIORENHEIM HAUS MONIKA UETZE - PERSONAS")
    print("="*70)
    ...
    # Zusammenfassung
    print(f"\n\n{'='*70}")
    print("ZUSAMMENFASSUNG - UETZE CREATIVES")
    print("="*70)
...
if __name__ == "__main__":
    asyncio.run(test_uetze_personas())
