"""
Generierung für Ökumenische Sozialstation Landau in der Pfalz
...
async def generate_all_creatives():
    """Generiert alle 6 Creatives für Landau"""
    
    print("=" * 80)
    print("ÖKUMENISCHE SOZIALSTATION LANDAU - 6 CREATIVES")
    print("=" * 80)
    ...
    primary_color = "#2B5A8E"  # Ökumenisch Blau
    ...
    personas = [
        {
            ...
            "subline": "Planbare Einsätze in Ihrer Nachbarschaft. Verlässliche Arbeitszeiten.",
            "cta": "Jetzt bewerben",
        ...
        },
        {
            ...
            "subline": "Begleitung bei Ihrem Neustart. Teilzeit möglich. Keine Überforderung.",
            "cta": "Neu starten",
        ...
        },
        {
            ...
            "subline": "Entwicklungsperspektiven. Werteorientierter Träger. Gestaltungsspielraum.",
            "cta": "Mehr erfahren",
    ...
    for i, persona in enumerate(personas, 1):
        ...
        pro_desc = "clean modern photography, professional healthcare setting, natural lighting"
        pro_brief = await brief_service.generate_brief(
            headline=persona['hook'],
            style=f"professional, trustworthy, clear, VISUAL STYLE: {pro_desc}",
        ...
        art_desc = "watercolor painting, soft brush strokes, warm caring tones, emotional atmosphere"
        art_brief = await brief_service.generate_brief(
            headline=persona['hook'],
            style=f"warm, meaningful, emotional, ARTISTIC RENDERING: {art_desc}",
            subline=persona['subline'],
            benefits=[],
            job_title=job_title,
            cta=persona['cta']
