"""
Test: Diakonie im Kirchenkreis Düsseldorf-Mettmann Personas - Professionell + Künstlerisch

Pflegefachkraft (ambulant/stationär) - Ratingen + Haan
...
LOCATION = "Ratingen + Haan"
JOB_TITLE = "Pflegefachkraft (m/w/d)"
COMPANY = "Diakonie Düsseldorf-Mettmann"
...
PERSONAS = [
    {
        "id": 1,
        "name": "Die wohnortnahe Teamstütze",
        "values": "Nähe, feste Teams",
        "pain": "ständige Wechsel, Überlastung",
        "hook": "Zwei Standorte, ein verlässlicher Plan – nah bei dir.",
        "subline": "Zwei Standorte. Feste Teams. Verlässliche Strukturen.",
        "cta": "Jetzt bewerben",
        "designer": "team",
    ...
    },
    {
        ...
        "pain": "kurzfristiges Einspringen, Schuldgefühle",
        "hook": "Sanfter Wiedereinstieg mit festen Tagen.",
        "subline": "Feste Tage. Planbare Teilzeit. Ohne Schuldgefühle.",
        "cta": "Mehr erfahren",
        "designer": "lifestyle",
    ...
    {
        "id": 3,
        "name": "Die mobile Pflegekraft",
        "values": "Struktur, Anerkennung",
        "pain": "Zeitdruck, unklare Touren",
        "hook": "Klare Dienste mit Führerschein-Bonus – ohne Leasingdruck.",
        "subline": "Strukturierte Touren. Faire Vergütung. Keine Leasingpflicht.",
        "cta": "Kennenlernen",
        "designer": "job_focus",
...
async def generate_persona_creative(persona: dict, is_artistic: bool):
    """
    Generiert ein Creative für Diakonie Düsseldorf-Mettmann Persona
    ...
    if is_artistic:
        ...
        artistic_desc = "watercolor painting, soft brush strokes, warm colors, caring illustration, community atmosphere"
        style_prompt = f"caring, values-driven, community, professional care, reliable, ARTISTIC RENDERING: {artistic_desc}"
        layout = persona['art_layout']
        visual = persona['art_visual']
        designer = "artistic"  # WICHTIG für künstlerische Motive
    else:
        # Professioneller Stil
        style_prompt = "caring, values-driven, community, professional care, reliable"
...
async def test_diakonie_personas():
    """Generiert 6 Creatives (3 Personas x 2 Stile) für Diakonie Düsseldorf-Mettmann"""
    print("="*70)
    print("DIAKONIE DÜSSELDORF-METTMANN - PERSONAS")
    print("="*70)
    ...
    # Zusammenfassung
    print(f"\n\n{'='*70}")
    print("ZUSAMMENFASSUNG - DIAKONIE DÜSSELDORF-METTMANN CREATIVES")
    print("="*70)
...
if __name__ == "__main__":
    asyncio.run(test_diakonie_personas())
