"""
Test: RehaNova Köln Personas - Professionell + Künstlerisch

Neurologische Rehabilitationsklinik - Pflegefachkraft Neurologie
...
LOCATION = "Köln"
JOB_TITLE = "Pflegefachkraft (m/w/d) Neurologische Rehabilitation"
COMPANY = "RehaNova Köln Neurologische Rehabilitationsklinik"
...
PERSONAS = [
    {
        "id": 1,
        "name": "Die akutermüdete Neuro-PFK",
        "values": "Fachlichkeit, ruhigere Abläufe",
        "pain": "Dauerstress, Notfälle, Überlastung",
        "hook": "Neurologie pflegen – mit Zeit statt Alarmmodus.",
        "subline": "Frühreha & Intensiv. Mehr Pflegezeit. Weniger Akutstress.",
        "cta": "Jetzt bewerben",
        "designer": "lifestyle",
    ...
    {
        "id": 2,
        "name": "Die erfahrene Intensiv-PFK",
        "values": "Spezialisierung, Wertschätzung",
        "pain": "Personalmangel, ständiges Einspringen",
        "hook": "Deine Intensiv-Expertise als Stabilitätsanker – nicht als Lückenfüller.",
        "subline": "Stabile Kernteams. Wertschätzung. Keine Springer-Rolle.",
        "cta": "Mehr erfahren",
        "designer": "job_focus",
    ...
    {
        "id": 3,
        "name": "Die planungssuchende Rückkehrerin",
        "values": "Planbarkeit, Teilzeit",
        "pain": "Schichtchaos, Schuldgefühle",
        "hook": "Zurück in die Pflege – mit klaren Diensten und festen Teams.",
        "subline": "Klare Dienste. Feste Teams. Planbare Teilzeit.",
        "cta": "Kennenlernen",
        "designer": "lifestyle",
...
async def generate_persona_creative(persona: dict, is_artistic: bool):
    """
    Generiert ein Creative für RehaNova Köln-Persona
    ...
    if is_artistic:
        ...
        style_prompt = f"caring, rehabilitative, supportive, ARTISTIC RENDERING: {artistic_desc}"
        layout = persona['art_layout']
        visual = persona['art_visual']
        designer = "artistic"  # WICHTIG für künstlerische Motive
    else:
        # Professioneller Stil
        style_prompt = "professional, rehabilitative, caring, specialized"
...
async def test_rehanova_personas():
    """Generiert 6 Creatives (3 Personas x 2 Stile) für RehaNova Köln"""
    print("="*70)
    print("REHANOVA KÖLN - PERSONAS")
    print("="*70)
    print(f"Standort: {LOCATION}")
    print(f"Klinik: {COMPANY}")
    ...
    # Zusammenfassung
    print(f"\n\n{'='*70}")
    print("ZUSAMMENFASSUNG - REHANOVA KÖLN CREATIVES")
    print("="*70)
...
if __name__ == "__main__":
    asyncio.run(test_rehanova_personas())
