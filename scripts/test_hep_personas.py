"""
Test: Teilhabe-HEP Personas - Professionell + Künstlerisch
...
JOB_TITLE = "Heilerziehungspfleger (m/w/d) Teilhabe"
...
PERSONAS = [
    {
        "id": 1,
        "name": "Die beziehungsorientierte Teilhabe-HEP",
        "values": "Beziehung, Sinn, Selbstbestimmung",
        "pain": "Angebotskürzungen, zu wenig Zeit, Dauerunterdeckung",
        "hook": "Teilhabe gestalten – wieder Zeit für Menschen statt Notbetrieb.",
        "subline": "Beziehungsarbeit. Selbstbestimmung. Zeit für echte Teilhabe.",
        "cta": "Kennenlernen",
        "designer": "lifestyle",
    ...
    {
        "id": 2,
        "name": "Die planbare Rückkehrerin",
        "values": "planbare Woche, sichere Stunden, Vereinbarkeit",
        "pain": "kurzfristiges Einspringen, Schuldgefühl, Chaosplanung",
        "hook": "Unbefristet, klare Woche – Arbeit, die in dein Leben passt.",
        "subline": "Planbare Zeiten. Unbefristet. Work-Life-Balance.",
        "cta": "Mehr erfahren",
        "designer": "lifestyle",
    ...
    {
        "id": 3,
        "name": "Die strukturstarke Fachkraft",
        "values": "Hilfeplanung, saubere Abläufe, Verlässlichkeit",
        "pain": "Improvisation, viele Wechsel, zäher Bewerbungsprozess",
        "hook": "Ein Team, ein Konzept – Teilhabe mit Struktur und Klarheit.",
        "subline": "Klare Prozesse. Hilfeplanung. Professionelle Strukturen.",
        "cta": "Jetzt bewerben",
        "designer": "team",
        "pro_layout": LayoutStyle.LEFT,
        "pro_visual": VisualStyle.PROFESSIONAL,
        "art_layout": LayoutStyle.SPLIT,
        "art_visual": VisualStyle.CLASSIC
    }
]
...
async def generate_persona_creative(persona: dict, is_artistic: bool):
    """
    Generiert ein Creative für HEP-Persona
    ...
    if is_artistic:
        ...
        style_prompt = f"inclusive, supportive, meaningful, ARTISTIC RENDERING: {artistic_desc}"
        layout = persona['art_layout']
        visual = persona['art_visual']
        designer = "artistic"  # WICHTIG für künstlerische Motive
    else:
        # Professioneller Stil
        style_prompt = "professional, supportive, inclusive, structured"
    ...
    result = await nano.generate_creative(
        job_title=JOB_TITLE,
        company_name="Teilhabe Bad Segeberg",
        headline=persona['hook'],
        cta=persona['cta'],
        location=LOCATION,
        subline=persona['subline'],
...
async def test_hep_personas():
    """Generiert 6 Creatives (3 Personas x 2 Stile)"""
    print("="*70)
    print("TEILHABE-HEP PERSONAS - PROFESSIONELL + KÜNSTLERISCH")
    print("="*70)
    ...
    # Zusammenfassung
    print(f"\n\n{'='*70}")
    print("ZUSAMMENFASSUNG - HEP TEILHABE CREATIVES")
    print("="*70)
