"""
Test: Künstlerische MOTIV-Generierung für Persona 1
"Die stabile Stationssäule"
...
async def generate_artistic_variant(style_name: str, style_description: str, layout: str, visual: str):
    ...
    artistic_style_prompt = f"professional, stable, trustworthy, ARTISTIC: {style_description}"
...
async def test_persona1_artistic():
    """Teste künstlerische Motive für Persona 1"""
    print("="*70)
    print("PERSONA 1: Die stabile Stationssäule")
    print("="*70)
    print(f"Hook: \"{HOOK}\"")
    ...
    # Zusammenfassung
    print(f"\n{'='*70}")
    print("ZUSAMMENFASSUNG - PERSONA 1 KÜNSTLERISCH")
    print("="*70)
...
if __name__ == "__main__":
    asyncio.run(test_persona1_artistic())
